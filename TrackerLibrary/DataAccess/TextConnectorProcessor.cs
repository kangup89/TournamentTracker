...
namespace TrackerLibrary.DataAccess.TextConnector
{
    ...
    {
        public static string FullFilePath(this string fileName) //PrirzeModels.csv
        {
        ...
        {
            //id, team name, list of ids sepparated by the pipe
            //3, Tim's Team, 1|3|5
        ...
        public static void SaveToRoundsToFile(this TournamentModel model)
        {
            // Loop through each Round
            // Loop through each Matchup
            // Get the id for teh new matchup and save the record
