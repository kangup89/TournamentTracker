...
namespace TrackerLibrary.DataAccess
{
    public class SqlConnector : IDataConnection
    {
        ...
        /// <returns>Theh prize informatiton, including the unique identifier</returns>
        ...
        public void CreateTeam(TeamModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                //p.Add("@TeamMembers", model.TeamMembers);
                p.Add("@id", 0, dbType: DbType.Int32, direction: ParameterDirection.Output);
        ...
        public void UpdateMatchup(MatchupModel model)
        {
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                // spMatchups_Update @int, @WinnerId
                var p = new DynamicParameters();
        ...
        public void CompleteTournament(TournamentModel model)
        {
            ...
            using (IDbConnection connection = new System.Data.SqlClient.SqlConnection(GlobalConfig.CnnString(db)))
            {
                ...
                connection.Execute("dbo.spTournaments.Complete", p, commandType: CommandType.StoredProcedure);
            }
        }
    }
}
